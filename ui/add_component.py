...
#
# Created: Mon Jul 15 13:57:02 2019
...
class Ui_AddComponentDialog(object):
    def setupUi(self, AddComponentDialog):
        ...
        self.pixelLayoutBox = QtWidgets.QGroupBox(self.geometryOptionsBox)
        self.pixelLayoutBox.setObjectName("pixelLayoutBox")
        self.gridLayout_2.addWidget(self.pixelLayoutBox, 4, 0, 1, 1)
    ...
    def retranslateUi(self, AddComponentDialog):
        ...
        self.pixelLayoutBox.setTitle(QtWidgets.QApplication.translate("AddComponentDialog", "Pixel options", None, -1))
