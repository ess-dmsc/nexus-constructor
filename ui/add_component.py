...
#
# Created: Wed Jun 19 09:31:41 2019
...
class Ui_AddComponentDialog(object):
    def setupUi(self, AddComponentDialog):
        ...
        self.pixelOptionsBox = QtWidgets.QGroupBox(self.groupBox)
        ...
        self.verticalLayout_3.addWidget(self.pixelOptionsBox)
        self.pixelDataBox = QtWidgets.QGroupBox(self.groupBox)
        ...
        self.pixelGridBox = QtWidgets.QGroupBox(self.groupBox)
    ...
    def retranslateUi(self, AddComponentDialog):
        ...
        self.groupBox.setTitle(QtWidgets.QApplication.translate("AddComponentDialog", "Pixel options:", None, -1))
