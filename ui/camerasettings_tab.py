...
class CameraSettingsTab(QWidget):
    def __init__(self, scene_widget: InstrumentView, parent=None):
        ...
        self.sceneWidget.camera_entity.viewCenterChanged.connect(self.read_current_values)
    ...
    def initialize_default_values(self):
        self.positionVector_x_dsb.setValue(self.sceneWidget.default_camera_settings['position'].x())
        self.positionVector_y_dsb.setValue(self.sceneWidget.default_camera_settings['position'].y())
        self.positionVector_z_dsb.setValue(self.sceneWidget.default_camera_settings['position'].z())
        self.viewCenterVector_x_dsb.setValue(self.sceneWidget.default_camera_settings['viewcenter'].x())
        self.viewCenterVector_y_dsb.setValue(self.sceneWidget.default_camera_settings['viewcenter'].y())
        self.viewCenterVector_z_dsb.setValue(self.sceneWidget.default_camera_settings['viewcenter'].z())
        self.cameraSpeed_dsb.setValue(self.sceneWidget.default_camera_settings['cameraspeed'])
        fieldofview, aspectratio, nearfield, farfield = self.sceneWidget.default_camera_settings['perspective']
    ...
    def read_current_values(self):
        self.positionVector_x_dsb.setValue(self.sceneWidget.camera_entity.position().x())
        self.positionVector_y_dsb.setValue(self.sceneWidget.camera_entity.position().y())
        self.positionVector_z_dsb.setValue(self.sceneWidget.camera_entity.position().z())
    ...
    def update_current_values(self):
        ...
        self.sceneWidget.current_camera_settings['cameraspeed'] = (
