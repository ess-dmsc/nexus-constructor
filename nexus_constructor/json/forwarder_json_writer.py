...
def generate_forwarder_command(
    ...
    """
    tree_dict = dict()
    stream_list = _extract_forwarder_stream_info(streams, provider_type, default_broker)
    tree_dict["streams"] = stream_list
    object_to_json_file(tree_dict, output_file)


def _extract_forwarder_stream_info(
    streams: Dict[str, Dict[str, Any]], provider_type: str, default_broker: str
                ...
                stream_list.append(
                    {
                        ...
                        "converter": {
                            ...
                            "topic": default_broker + stream["topic"],
                        },
